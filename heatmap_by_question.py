...
# Cleaner display names for the figure
...
heatmap_df = df.set_index("model")[question_types]
...
ax.set_xticks(
    np.arange(-0.5, len(question_types), 1),
    minor=True,
)
...
plt.savefig(
    "results/question_type_heatmap.pdf",
    bbox_inches="tight",
)

plt.savefig(
    "results/question_type_heatmap.png",
    dpi=300,
    bbox_inches="tight",
)
